...
server <- function(input, output) {
  ...
  renderBarChart(div_id = "test_3", grid_left = '3%', data = dat_2, font.size.legend=15,show.tools=TRUE,show.legend = TRUE)
  
  #grid_right, padrao eh 4% #grid_top padrao eh 16% #grid_bottom 3% #
  
  renderBarChart(div_id = "test_4", theme = tema1, direction = "vertical", grid_left = "10%", data = dat_2)
