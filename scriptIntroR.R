...
#Link: https://www.digitalocean.com/community/tutorials/how-to-install-r-on-ubuntu-20-04-pt
...
write.csv(corrida,"/home/rodrigo/Área de Trabalho/RStudio/corrida1.csv", row.names = TRUE)
